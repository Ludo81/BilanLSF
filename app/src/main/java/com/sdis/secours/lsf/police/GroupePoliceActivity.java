...
import com.sdis.secours.lsf.databinding.GroupeBinding;

import java.io.IOException;

public class GroupePoliceActivity extends BasePoliceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            // Récupérer l'AssetManager et lister les vidéos dans "assets/videos/police/"
            ...
            for (String name : videoFiles) {
                if (groupe != null && name.startsWith(groupe)) {
                    ...
                    button.setOnClickListener(view -> {
                        Intent intent = new Intent(GroupePoliceActivity.this, VideoPoliceActivity.class);

...
public class ClavierInversePompierActivity extends BasePompierActivity {
    ...
    public void inverser(View view) {
        Intent intent = new Intent(ClavierInversePompierActivity.this, ClavierPompierActivity.class);

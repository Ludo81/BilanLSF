...
public class ClavierInversePoliceActivity extends BasePoliceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Logger.write(this, "Chargement Clavier inverse");
    ...
    public void inverser(View view) {
        Intent intent = new Intent(ClavierInversePoliceActivity.this, ClavierPoliceActivity.class);

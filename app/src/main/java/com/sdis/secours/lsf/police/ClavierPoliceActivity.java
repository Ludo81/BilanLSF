...
public class ClavierPoliceActivity extends BasePoliceActivity {
    ...
    public void inverser(View view) {
        Intent intent = new Intent(ClavierPoliceActivity.this, ClavierInversePoliceActivity.class);
    ...
    public void oui(View view) {
        final Dialog dialog = new Dialog(ClavierPoliceActivity.this);
